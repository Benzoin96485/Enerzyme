...
from .attention import E2AttentionClusterSparse, E2AttentionSparse
...
class ClusterTransBlock(nn.Module):
    """Long-range atom→fragment TransBlock (E2Former-LSR)."""
    ...
    def __init__(
        ...
        self.ga = E2AttentionClusterSparse(
            irreps_node_input=self.irreps_node_input,
            attn_weight_input_dim=attn_weight_input_dim,
            num_attn_heads=num_attn_heads,
            attn_scalar_head=attn_scalar_head,
    ...
    def forward(
        ...
        **kwargs,
        ...
        node_irreps, attn_weight = self.ga(
            ...
            cluster_irreps_input=cluster_irreps,
        )
        node_irreps = residual + node_irreps

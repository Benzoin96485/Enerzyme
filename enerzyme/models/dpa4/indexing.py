"""SO(3) packed-index helpers for DPA4 / EMFA SO(2).

Reimplemented for Enerzyme after deepmd-kit ``dpa4_nn.indexing``
(LGPL-3.0-or-later; Li et al., arXiv:2606.02419).
"""
...
# Short local spelling used by the DPA4 modules.

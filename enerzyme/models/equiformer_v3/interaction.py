"""EquiformerV3 attention / FFN / TransBlock (adapted from upstream MIT).

Source: atomicarchitects/equiformer_v3 experimental/models/equiformer_v3/
...
from ..so3.layer_norm import get_normalization_layer, RMSNorm

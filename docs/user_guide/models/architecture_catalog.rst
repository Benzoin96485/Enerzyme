...
**Maximum accuracy on diverse geometries**
    MACE, NequIP, Equiformer, EquiformerV2, EquiformerV3, E2Former, E2Former-V2, or So3krates — equivariant message passing; tune cutoff and depth.
